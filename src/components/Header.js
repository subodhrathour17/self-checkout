...
function Header({ pageName, pageTitle }) {
	...
	const pagesWithOneLogo = ["payment-modes", "credit-debit", "gift-voucher", "digital-wallet"];
	...
	const renderLogoOrBackButton = () => {
		if (pagesWithTwoLogos.includes(pageName)) {
            ...
            console("Man, pass a correct 'pageName' prop to Header. The pageName prop value should be an element of 'pagesWithTwoLogos' or 'pagesWithOneLogo'.");
        }
	};
